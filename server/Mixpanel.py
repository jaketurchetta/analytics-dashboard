...
class Mixpanel(object):
    ...
    def request(self, methods, params, http_method="GET", format="json"):
        ...
        headers = {
            "Authorization": "Basic {encoded_secret}".format(
...
if __name__ == "__main__":
    api = Mixpanel(api_secret="6f42f59d07f227c868606ebfdeadc50a")
    data = api.request(
        ["events"], {"event": ["pages"], "unit": "hour", "interval": 24, "type": "general"}
    )
    print(data)
